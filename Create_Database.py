...
#cur.execute("INSERT INTO Effects VALUES('Disease Resistance (104)', 'MnS Spell', 'Extra warding against Disease\n+1 TD bonus on extra warding attempt per 2 Spiritual Lore, Blessings ranks ',  'TD_Disease|Spellburst',  'Spiritual Lore, Blessings ranks:202',  'Calculate_104',  'NONE' ) ")
#cur.execute("INSERT INTO Effects VALUES('Poison Resistance (105)', 'MnS Spell', 'Extra warding attempt against Posion\n+1 TD bonus on extra warding attempt per 2 Spiritual Lore, Blessings ranks ',  'TD_Posion|Spellburst',  'Spiritual Lore, Blessings ranks:202',  'Calculate_105',  'NONE' ) ")
...
cur.execute("INSERT INTO Effects VALUES('Elemental Targeting (425)', 'MnE Spell', '+25 all AS, UAF and Elemental CS\n+1 all AS, UAF and Elemental CS per 2 Spell Research, Minor Elemental ranks above 25 up to a +50 at 75 ranks',  'AS_All|UAF|CS_Elemental|CS_Mental|CS_Spiritual|CS_Sorcerer|Spellburst',  'Spell Research, Minor Elemental ranks:303',  'Calculate_425',  'NONE' ) ")
...
cur.execute("INSERT INTO Effects VALUES('Strength (509)', 'MjE Spell', '+15 melee AS, UAF\n+1 melee AS, UAF when self-cast per seed 4 summation of Elemental Lore, Earth ranks',  'AS_Melee|UAF|Spellburst',  'Elemental Lore, Earth ranks:202',  'Calculate_509',  'NONE' ) ")
...
cur.execute("INSERT INTO Effects VALUES(\"Phoen\'s Strength (606)\", 'Rngr Spell', '+10 melee AS, UAF',  'AS_Melee|UAF|Spellburst',  'NONE',  'Calculate_606',  'NONE' ) ")
...
#cur.execute("INSERT INTO Effects VALUES('Assume Aspect (650) Burgee', 'Rngr Spell', '+10% Block chance\n+1% Block chance per seed 2 summation of Spiritual Lore, Blessings ranks',  'Block_Chance|Spellburst',  'Spiritual Lore, Summoning ranks:202',  'Calculate_650_Burgee',  'NONE' ) ")
...
#cur.execute("INSERT INTO Effects VALUES('Assume Aspect (650) Serpent', 'Rngr Spell', '+10% Evade chance\n+1% Evade chance per seed 2 summation of Spiritual Lore, Blessings ranks',  'Evade_Chance|Spellburst',  'Spiritual Lore, Summoning ranks:202',  'Calculate_650_Serpent',  'NONE' ) ")
#cur.execute("INSERT INTO Effects VALUES('Assume Aspect (650) Spider', 'Rngr Spell', '+20 Climbing ranks\n+1 Climbing rank per seed 2 summation of Spiritual Lore, Summoning ranks\nDouble Wed (108) charges and Web bolt causes an addition -25 (-50 total) Spiritual TD pushdown',  'Skill_Ranks_Climbing|Spellburst',  'Spiritual Lore, Summoning ranks:202',  'Calculate_650_Spider',  'NONE' ) ")
...
cur.execute("INSERT INTO Effects VALUES('Beacon of Courage (1608)', 'Pala Spell', '+1 enemy ignored in Force on Force.\n+1 additional enemy ignored per seed 10 summation of Spiritual Lore, Blessings ranks',  'Force_On_Force',  'Spiritual Lore, Blessings ranks:202',  'Calculate_1608',  'NONE' ) ")
...
# Status effects
cur.execute("INSERT INTO Effects VALUES('Kneeling', 'Status', '-50 AS and DS, +30 ranged AS if using a crossbow\n+5% stamina recovery',  'AS_All|DS_All|Stamina_Recovery',  'NONE',  'Calculate_Kneeling',  'crowbow_override' ) ")
cur.execute("INSERT INTO Effects VALUES('Lying Down', 'Status', '-50 AS and DS\n+5% stamina recovery',  'AS_All|DS_All|Stamina_Recovery',  'NONE',  'Calculate_Lying_Down',  'NONE' ) ")
cur.execute("INSERT INTO Effects VALUES('Overexerted', 'Status', '-10 AS/UAF.\nAlso known as Popped Muscles',  'AS_All|UAF',  'NONE',  'Calculate_Overexerted',  'crowbow_override' ) ")
...
# Items - TODO
#cur.execute("INSERT INTO Effects VALUES('DB Item', 'Item', 'Increases all DS by 1-50',  'DS_All',  'Generic DS Bonus:1-50',  'Calculate_Item_DB',  'no_dynamic_scaling' ) ")
'''
Aura Crystal, Lesser +5 Aura enchancive???
Aura Crystal, Greater +10 Aura enchancive???
Intuition Crystal, Lesser +5 Intuition enchancive???
Intuition Crystal, Greater +10 Intuition enchancive???
Constitution Crystal, Lesser +5 Constitution enchancive???
Constitution Crystal, Greater +10 Constitution enchancive???
Strength Crystal, Lesser +5 Strength enchancive???
Strength Crystal, Greater +10 Strength enchancive???
Wisdom Potion, Lesser +5 Wisdom enchancive???
Wisdom Potion, Greater +10 Wisdom enchancive???
Logic Potion, Lesser +5 Logic enchancive???
Logic Potion, Greater +10 Logic enchancive???
Mana Regeneration Potion, Minor  +3
Mana Regeneration Potion, Lesser +8
Mana Regeneration Potion, Greater +13
Spirit Regeneration Crystal, Minor  +1
Spirit Regeneration Crystal, Lesser +2
Spirit Regeneration Crystal, Greater +3
Stamina Regeneration Crystal, Minor  +10
Stamina Regeneration Crystal, Lesser +20
Stamina Regeneration Crystal, Greater +30
Health-well Potion, Minor +10 max health
Health-well Potion, Lesser +25 max health
Health-well Potion, Greater +50 max health
Mana-well Potion, Minor +10 max mana
Mana-well Potion, Lesser +25 max mana
Mana-well Potion, Greater +50 max mana
Spirit-well Potion, Minor +1 max spirit
Spirit-well Potion, Lesser +2 max spirit
Spirit-well Potion, Greater +3 max spirit
...
Elemental Focus Potion, Minor +10 elemental CS
Elemental Focus Potion, Lesser +15 elemental CS
Elemental Focus Potion, Greater +25 elemental CS
...
cur.execute("INSERT INTO Effects VALUES('Bright', 'Room Effects', '-10 DS',  'DS_All',  'NONE',  'Calculate_Room_Bright',  'NONE' ) ")
cur.execute("INSERT INTO Effects VALUES('Dark', 'Room Effects', '+20 DS',  'DS_All',  'NONE',  'Calculate_Room_Dark',  'NONE' ) ")
cur.execute("INSERT INTO Effects VALUES('Foggy', 'Room Effects', '+30 DS',  'DS_All',  'NONE',  'Calculate_Room_Foggy',  'NONE' ) ")
# Node
# Supernode
