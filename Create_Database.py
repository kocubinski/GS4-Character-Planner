...
cur.execute("CREATE TABLE Races (name, manauever_bonus, max_health, health_regen, health_gain_rate, spirit_regen_tier, decay_timer, encumberance_factor, weight_factor, elemental_td, mental_td, spiritual_td, sorc_td, poison_td, disease_td, strength_bonus, constitution_bonus, dexterity_bonus, agility_bonus, discipline_bonus, aura_bonus, logic_bonus, intuition_bonus, wisdom_bonus, influence_bonus, strength_adj, constitution_adj, dexterity_adj, agility_adj, discipline_adj, aura_adj, logic_adj, intuition_adj, wisdom_adj, influence_adj)")
   
cur.execute("INSERT INTO Races VALUES('Aelotoi', 'good', 120, 1, 5, 2, 10, 0.75, 0.65, 0, 0, 0, 0, 0, 0,  -5, 0, 5, 10, 5, 0, 5, 5, 0, -5,  0, -2, 3, 3, 2, 0, 0, 2, 0, -2) ")
cur.execute("INSERT INTO Races VALUES('Burghal Gnome', 'best', 90, 1, 4, 3, 14, 0.78, 0.7, 0, 0, 0, 0, 0, 0,  -15, 10, 10, 10, -5, 5, 10, 5, 0, -5,  -5, 0, 3, 3, -3, -2, 5, 5, 0, 0) ")
cur.execute("INSERT INTO Races VALUES('Dark Elf', 'good', 120, 1, 5, 1, 10, 0.84, 0.75, -5, 0, -5, -5, 10, 100,  0, -5, 10, 5, -10, 10, 0, 5, 5, -5,  0, -2, 5, 5, -2, 0, 0, 0, 0, 0) ")
cur.execute("INSERT INTO Races VALUES('Dwarf', 'average', 140, 3, 6, 4, 16, 0.8, 0.75, 30, 0, 0, 15, 20, 15,  10, 15, 0, -5, 10, -10, 5, 0, 0, -10,  5, 5, -3, -5, 3, 0, 0, 0, 3, -2) ")
cur.execute("INSERT INTO Races VALUES('Elf', 'excellent', 130, 1, 5, 1, 10, 0.78, 0.7, -5, 0, -5, -5, 10, 100,  0, 0, 5, 15, -15, 5, 0, 0, 0, 10,  0, -5, 5, 3, -5, 5, 0, 0, 0, 3) ")
cur.execute("INSERT INTO Races VALUES('Erithian', 'good', 120, 1, 5, 2, 13, 0.85, 0.75, 0, 0, 0, 0, 0, 0,  -5, 10, 0, 0, 5, 0, 5, 0, 0, 10,  -2, 0, 0, 0, 3, 0, 2, 0, 0, 3) ")
cur.execute("INSERT INTO Races VALUES('Forest Gnome', 'excellent', 100, 1, 4, 4, 16, 0.6, 0.45, 0, 0, 0, 0, 0, 0,  -10, 10, 5, 10, 5, 0, 5, 0, 5, -5,  -3, 2, 2, 3, 2, 0, 0, 0, 0, 0) ")
...
cur.execute("INSERT INTO Races VALUES('Half Elf', 'good', 135, 2, 5, 2, 10, 0.92, 0.8, -5, 0, -5, -5, 0, 50,  0, 0, 5, 10, -5, 0, 0, 0, 0, 5,  2, 0, 2, 2, -2, 0, 0, 0, 0, 2) ")
...
cur.execute("INSERT INTO Races VALUES('Sylvankind', 'good', 130, 1, 5, 2, 10, 0.81, 0.7, -5, 0, -5, -5, 10, 100,  0, 0, 10, 5, -5, 5, 0, 0, 0, 0,  -3, -2, 5, 5, -5, 3, 0, 0, 0, 3) ")
...
cur.execute("INSERT INTO Effects VALUES('Manna (203)', 'MjS Spell', '+5 maximum Mana per seed 10 summation for Spiritual Lore, Blessing ranks',  'Resource_Maximum_Mana',  'Spiritual Lore, Blessings ranks:303',  'Calculate_203',  'NONE' ) ")
...
cur.execute("INSERT INTO Effects VALUES('Shield Forward', 'Maneuver', '+10 enhancive Shield Use ranks to per maneuver rank',  'Skill_Ranks_Shield_Use',  'Maneuver ranks:1-3',  'Calculate_Shield_Forward',  'NONE' ) ")
...
cur.execute("INSERT INTO Effects VALUES('Acuity AS Flare', 'Flare', '+5 bonus to bolt AS on next spell cast per tier',  'AS_Bolt',  'Tier:0-10',  'Calculate_Acuity_AS_Flare',  'NONE' ) ")
cur.execute("INSERT INTO Effects VALUES('Acuity CS Flare', 'Flare', '+3 bonus to all CS on next cast per tier',  'CS_All',  'Tier:0-10',  'Calculate_Acuity_CS_Flare',  'NONE' ) ")
cur.execute("INSERT INTO Effects VALUES('Ensorcell AS Flare', 'Flare', '+5/+10/+15/+20/+25 bonus to AS on next melee, ranged, UAF attack',  'AS_All|UAF',  'Tier:0-5',  'Calculate_Ensorcell_AS_Flare',  'NONE' ) ")
cur.execute("INSERT INTO Effects VALUES('Ensorcell CS Flare', 'Flare', '+5/+10/+15/+20/+25 bonus to all CS',  'CS_All',  'Tier:0-5',  'Calculate_Ensorcell_CS_Flare',  'NONE' ) ")
